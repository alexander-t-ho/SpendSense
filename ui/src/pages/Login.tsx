...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Use email as username, password from input
      if (!password) {
        ...
        <div className="p-8">
          ...
          <div>
            ...
            <h1 className="mt-6 text-pretty text-2xl font-semibold leading-snug">
              <span className="block text-muted-foreground">Welcome back to SpendSense!</span>
              Sign in to continue
            </h1>
          </div>

          {/* Social Buttons - Optional, can be removed or implemented later */}
          ...
          <div className="space-y-4">
            ...
            <div className="text-center text-sm text-muted-foreground">
              <p>Demo: Use your email and password "123456"</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-8 py-6 border-t border-border text-center">
          <p className="text-sm text-muted-foreground">
            ...
            <Button asChild variant="link" size="sm" className="px-1">
              <Link to="/login">Contact admin</Link>
            </Button>
          </p>
        </div>
      </form>
